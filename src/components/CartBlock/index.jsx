      ...
      <div className='content__items'>
        <div className={styles.item}>
          ...
          <div className={styles.itemCount}>
            ...
            <b>2</b>
            <div className={`button button--outline button--circle ${styles.itemCountPlus}`}>
              <svg
                width='10'
                height='10'
                viewBox='0 0 10 10'
          ...
          <div className={styles.itemRremove}>
        ...
        <div className={styles.item}>
          ...
          <div className={styles.itemRremove}>
            <div className={`button button--outline button--circle ${styles.itemRemoveButton}`}>
              <svg
                width='10'
                height='10'
                viewBox='0 0 10 10'
